...
export class MediaClient<
  TItem extends MediaItem<MediaType, string>,
...
> {
  ...
  public trending<TResponse = MediaListResponse<TItem>>(
    options: MediaListOptions<
      Extract<keyof TItem["file"][keyof TItem["file"]], string>
    > = {},
  ): Promise<TResponse> {
    return this.http.request<TResponse>(
      `${this.endpoint}/trending${this.http.buildQuery({
        ...
        format_filter: Array.isArray(options.formatFilter)
          ? options.formatFilter.join(",")
  ...
  public search<TResponse = MediaListResponse<TItem>>(
    query: string,
    options: MediaListOptions<
      Extract<keyof TItem["file"][keyof TItem["file"]], string>
    > = {},
  ...
  public categories<TResponse = MediaCategoriesResponse<TCategory>>(
    locale?: string,
  ): Promise<TResponse> {
    return this.http.request<TResponse>(
  ...
  public recent<TResponse = MediaListResponse<TItem>>(
    customerId: string,
  ...
  public items<TResponse = MediaListResponse<TItem>>(
    slugs: string[] | string,
  ): Promise<TResponse> {
  ...
  public deleteRecent<TResponse = MediaActionResponse>(
    customerId: string,
    slug: string,
  ): Promise<TResponse> {
    return this.http.request<TResponse>(
  ...
  public share<TResponse = MediaActionResponse>(
    slug: string,
  ...
  public report<TResponse = MediaActionResponse>(
    slug: string,
